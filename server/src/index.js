...
app.get('/healthz', (_req, res) =>
  res.json({ ok: true, service: 'us-washingtons-war', liveSessions: manager.registry.sessions.size }));
...
server.listen(config.port, () => {
  console.log(`[us-washingtons-war] listening on :${config.port} — sessions live in memory only`);
});
