// MetersBar.jsx — the three 0–100 meters (Army 🪖, Supplies 🎒, Morale 🔥).
// Icons + labels + numbers, never color alone. Flashes a +/- chip when a meter
// changes. These are DRAMA (spec §3) — they never decide accuracy.

import { useEffect, useRef, useState } from 'react';

const ICONS = { army: '🪖', supplies: '🎒', morale: '🔥' };
